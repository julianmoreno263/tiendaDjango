...
#importacion de etiquetas de django para mensajes de error
...
SECRET_KEY = 'django-insecure-wk_hk1j^by1=qv(%9!ix4(hevf^3loo&d1a2-x*#z2kksde9^$'
...
# tema oscuro para el admin de django usando paquete jazzmin
JAZZMIN_UI_TWEAKS = {
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "julianmoreno263@gmail.com"
EMAIL_HOST_PASSWORD = "zwkqipnyokgqtczt"
